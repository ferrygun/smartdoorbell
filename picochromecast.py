...
def play_url(url, host):
    ...
    msg = (b'\x08\x00\x12\x08sender-0\x1a$%s" urn:x-cast:com.google.cast.media(\x002' % transport_id.encode('utf-8')) + calc_variant(len(payload)) + payload.encode('utf-8')
